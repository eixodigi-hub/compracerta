-- Navegar por categoria sem digitar texto batia sempre no teto de 100
-- resultados (e a tela só pedia 30 por vez, sem "carregar mais"), o que
-- fazia catálogos grandes (ex.: Alimentos com milhares de produtos)
-- parecerem vazios/pobres. Sobe o teto rígido da função pra acompanhar o
-- botão "Carregar mais" adicionado na tela de busca.
