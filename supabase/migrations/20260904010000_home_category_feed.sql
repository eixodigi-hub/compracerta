-- Feed da tela inicial organizado por categoria: pra cada categoria, traz
-- até N produtos (padrão 10), priorizando quem está em promoção e com
-- maior desconto, depois os mais recentemente atualizados. Só considera
-- produtos canônicos já associados a uma categoria (sem categoria não dá
-- pra agrupar em carrossel).
